    ...
    <div class="lg:col-span-5 space-y-6 lg:space-y-8 w-full overflow-hidden">
        ...
        <div class="bg-gradient-to-br from-slate-900 via-blue-950 to-red-950 dark:from-slate-900 dark:via-blue-950 dark:to-slate-950 rounded-[1.5rem] md:rounded-[2.5rem] p-6 sm:p-8 text-white shadow-xl shadow-slate-900/10 dark:shadow-none relative overflow-hidden transition-all border border-amber-500/10 dark:border-slate-700/60 w-full">
            ...
            <div class="relative z-10">
                ...
                <p class="text-slate-200 dark:text-slate-400 text-xs sm:text-sm font-medium leading-relaxed opacity-90 break-words">
                    Perubahan pada halaman ini berdampak langsung pada database master Spreadsheet. Pastikan data akun and opsi keperluan baru yang dimasukkan sudah tervalidasi dengan benar.
                </p>
            </div>
        </div>
