...
<body class="min-h-screen flex flex-col items-center justify-center p-4 sm:p-6 bg-[#F1F5F9] text-slate-800 dark:bg-slate-950 dark:text-slate-100 transition-colors duration-300">
    ...
    {{-- VARIABEL PENGECEKAN KONDISI SURVEI --}}
    @php
    ...
    <div class="relative w-full max-w-sm sm:max-w-md my-4">
        ...
        @if($harusIsiSurvei)
            <div class="absolute inset-0 z-50 flex flex-col items-center justify-center">
                ...
                <div class="relative z-50 bg-white dark:bg-slate-900 p-6 sm:p-8 rounded-3xl shadow-2xl border border-slate-200 dark:border-slate-700 text-center w-11/12 mx-auto animate-popup">
                    <div class="w-16 h-16 bg-amber-100 dark:bg-amber-900/30 rounded-full flex items-center justify-center mx-auto mb-4">
                        <i class="fa-solid fa-star text-3xl text-amber-500"></i>
                    </div>
                    <h3 class="text-lg sm:text-xl font-black text-slate-800 dark:text-slate-100 mb-2 uppercase tracking-wide">Layanan Selesai!</h3>
            ...
            <div class="bg-white dark:bg-slate-900 rounded-3xl sm:rounded-[2.5rem] p-6 sm:p-8 shadow-sm border border-slate-100 dark:border-slate-800 transition-colors duration-300">
                ...
                <div class="relative space-y-8 sm:space-y-10">
                    ...
                    <div class="relative pl-8 sm:pl-10">
                        <div class="absolute left-0 top-1 w-6 h-6 rounded-full ring-4 ring-white dark:ring-slate-900 z-10 flex items-center justify-center {{ $kunjungan->status_layanan == 'Selesai' ? 'bg-emerald-500 shadow-lg shadow-emerald-100 dark:shadow-none' : 'bg-slate-200 dark:bg-slate-700' }}">
                            @if($kunjungan->status_layanan == 'Selesai')
                    ...
                    {{-- STATUS 2: DIPROSES --}}
                    <div class="relative pl-8 sm:pl-10">
                        <div class="absolute left-0 top-1 w-6 h-6 rounded-full ring-4 ring-white dark:ring-slate-900 z-10 flex items-center justify-center {{ in_array($kunjungan->status_layanan, ['Diproses', 'Selesai']) ? 'bg-[#0b3a82] dark:bg-blue-500 shadow-lg shadow-blue-100 dark:shadow-none' : 'bg-slate-200 dark:bg-slate-700' }}">
